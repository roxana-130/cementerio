<x-app-layout>
    <x-slot name="header">
        <div class="d-flex align-items-center gap-2">
            ...
            <h1 class="h4 mb-0 fw-bold text-dark">Registrar Nuevo Difunto</h1>
        </div>
    </x-slot>
        ...
        <div class="col-lg-10">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 pt-4 px-4">
                    ...
                    <p class="text-muted small mb-0">Complete la información requerida del difunto. Los campos marcados con (<span class="text-danger">*</span>) son obligatorios.</p>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('difuntos.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="codigo" id="codigo" value="{{ old('codigo') }}"
                                    ...
                                    placeholder="Ej. DIF-0001 (opcional)">
                                <div class="form-text">Si se deja en blanco, se autogenera (ej. DIF-0001).</div>
                                @error('codigo')
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="apellido_casada" id="apellido_casada" value="{{ old('apellido_casada') }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="edad" id="edad" value="{{ old('edad') }}" min="0" max="120"
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" name="profesion_ocupacion" id="profesion_ocupacion" value="{{ old('profesion_ocupacion') }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="fecha_fallecimiento" id="fecha_fallecimiento" 
                                    value="{{ old('fecha_fallecimiento', date('Y-m-d')) }}" max="{{ date('Y-m-d') }}" required
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="time" name="hora_fallecimiento" id="hora_fallecimiento" value="{{ old('hora_fallecimiento') }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="numero_certificado_defuncion" id="numero_certificado_defuncion" 
                                    value="{{ old('numero_certificado_defuncion') }}"
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="causa_muerte" id="causa_muerte" rows="3"
                                    ...
                                    placeholder="Descripción o causa médica según certificado de defunción...">{{ old('causa_muerte') }}</textarea>
                                @error('causa_muerte')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 border-top pt-3 mt-4">
                            ...
                            <button type="submit" class="btn btn-success px-4 shadow-sm">
                                <i class="bi bi-check-circle me-1"></i>Guardar Difunto
                            </button>
                        </div>
                    </form>
                </div>

        ...
        <div class="container py-4">
            <div class="row justify-content-center">
                <div class="col-lg-9 text-center">
                    <h1 class="display-5 fw-bold mb-3">Plataforma Web de Consulta Pública</h1>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-3">
                        <a href="{{ route('publico.buscar') }}" class="btn btn-light btn-lg px-4 fw-semibold shadow-sm text-dark">
                            <i class="bi bi-search me-2 text-success"></i>Buscar Difunto
                        </a>
                        <a href="{{ route('publico.mapa') }}" class="btn btn-outline-light btn-lg px-4 fw-semibold">
                            <i class="bi bi-map me-2"></i>Ver Mapa Interactivo
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4 p-md-5">
                        ...
                        {{-- Texto placeholder institucional solicitado --}}
                        <div class="alert alert-secondary border-0 mb-4 text-center py-4">
                            <p class="fs-5 mb-0 fw-medium text-dark">
                                [Nombre del cementerio] — información institucional pendiente de redactar
                            </p>
                        </div>
